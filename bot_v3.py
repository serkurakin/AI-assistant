...
prompt = ChatPromptTemplate.from_messages([
   ...
   ПРАВИЛА ЦИТИРОВАНИЯ (НАРУШЕНИЕ ЗАПРЕЩЕНО):
    1. Ты ОБЯЗАН ставить ссылку в квадратных скобках [имя_файла.pdf] СРАЗУ ПОСЛЕ каждого предложения, где приводится факт из статьи.
    2. Не жди конца абзаца — ставь ссылку после каждого утверждения.
    3. Если утверждение общее (из интернета), ставь [Интернет].
    4. Твой ответ БЕЗ ссылок внутри текста будет считаться ОШИБКОЙ.
    5. Пример: 'Белки состоят из аминокислот [article1.pdf]. Они могут иметь разную структуру [article1.pdf].'
